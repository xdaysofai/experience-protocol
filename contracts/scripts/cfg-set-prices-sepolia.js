...
const HUMAN_PRICES = {
  // Ethereum Sepolia testnet prices:
...
async function main() {
  ...
  const WETH = process.env.WETH_SEPOLIA || "";
  const DAI  = process.env.DAI_SEPOLIA  || "";
  ...
  console.log("Done configuring prices on Ethereum Sepolia!");
}
